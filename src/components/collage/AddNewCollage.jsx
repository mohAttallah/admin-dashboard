...
import { addNewCollage } from "../../redux/universityslice";

import SnackbarMsg, { Severity, AnchorOrigin } from '../SnackbarMsg';
import SelectComponent from "../../components/Select";

export default function AddNewCollage({ universityOptions, open, handleClose }) {
    ...
    const { addNewCollageSuccessfully, addNewCollageError } = useSelector((state) => state.university);
    ...
    const handleSubmit = (event) => {
        ...
        if (!name || !nameInArabic || !universityId) {
            ...
            dispatch(addNewCollage({ name, nameInArabic, universityId }))
            setName(null)
    ...
    return (
        <div>
            {addNewCollageError && <SnackbarMsg text={"Failed"} severity={Severity.ERROR} anchorOrigin={AnchorOrigin.BOTTOM_LEFT} />}
            {addNewCollageSuccessfully && <SnackbarMsg text={"Create Collage Successfully"} severity={Severity.SUCCESS} anchorOrigin={AnchorOrigin.BOTTOM_LEFT} />}
